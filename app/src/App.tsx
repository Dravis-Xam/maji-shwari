        ...
        <header className="topbar">
          ...
          <div className="top-actions">
            <div style={{ position: 'relative' }}>
              ...
              {/* Dropdown lives as a sibling of .search, not nested inside it,
                  so it can never be constrained by that pill's own box (fixed
                  height, flex layout) regardless of how that class evolves. */}
