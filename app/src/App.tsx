  ...
  return <div className="app-shell">
    <aside className="sidebar">
      ...
      <nav><p className="nav-label">Workspace</p>
        ...
        <p className="nav-label nav-spacer">System</p><button className="nav-item"><ShieldCheck size={17} /> Verification rules</button><button className="nav-item"><Activity size={17} /> Activity log</button>
      </nav>
